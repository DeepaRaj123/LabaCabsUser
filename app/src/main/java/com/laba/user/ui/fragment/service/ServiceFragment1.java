...
import com.laba.user.ui.adapter.ServiceAdapter1;
...
public class ServiceFragment1 extends BaseFragment implements ServiceIView {

    private final ServicePresenter<ServiceFragment1> presenter = new ServicePresenter<>();
            ...
            case R.id.get_pricing:
                if (adapter != null) {
                    ...
                    if (service != null && service.isAvailable()) {
                        Log.e("SERVICES", "Service ID: " + service.getId());
                        ...
                        Toasty.error(getContext(), "Car Not Available!").show();
                    }
//                    else {
...
//            }
            ...
            serviceRv.setVisibility(View.VISIBLE);
            noServiceText.setVisibility(View.GONE);
            adapter = new ServiceAdapter1(getActivity(), mServices, mListener, capacity, mEstimateFare, new ServiceAdapter1.ServiceAdapterOnClickListener() {
                @Override
                public void adapterClick(Service service) {
                    ...
                    proceedBt.setText(service.isAvailable() ?
                            "CONFIRM " + service.getName()
                            : "NOT AVAILABLE " + service.getName()
                    );
                }
            }, firstAvailable);
...
//            } else {
//                proceedBt.setText("CONFIRM " + adapter.getServiceTypeName(firstAvailable));
//            }
            if (adapter != null) {
                ...
                if (mService != null) {
                    ...
                    proceedBt.setText(mService.isAvailable() ?
                            "CONFIRM " + adapter.getServiceTypeName(firstAvailable)
                            : "NOT AVAILABLE " + adapter.getServiceTypeName(firstAvailable)
                    );
                }
            }
